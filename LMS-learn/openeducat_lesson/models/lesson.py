...
class OpLesson(models.Model):
    ...
    def _check_date_time(self):
        for lesson in self:
            if (lesson.start_datetime and lesson.end_datetime and
                    lesson.start_datetime > lesson.end_datetime):
    ...
    def onchange_course(self):
        if self.course_id:
            subject_ids = self.course_id.subject_ids
            return {
    ...
    def onchange_faculty_id(self):
        if self.faculty_id:
            session_ids = self.faculty_id.session_ids
            return {
