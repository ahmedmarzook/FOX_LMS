...
patch(FormRenderer.prototype, {
    setup() {
        ...
        this.chatterState = useState({
            width: browser.localStorage.getItem('eds_web_chatter.width'),
        });
    ...
    onStartChatterResize(ev) {
        ...
        const resizePanel = (ev) => {
            ...
            browser.localStorage.setItem('eds_web_chatter.width', newWidth);
    ...
    onDoubleClickChatterResize(ev) {
    	browser.localStorage.removeItem('eds_web_chatter.width');
