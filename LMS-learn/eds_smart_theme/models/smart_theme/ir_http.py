...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        is_bg_color = request.session.get("bg_color", False)
            ...
            res.update(
                {
                    ...
                    "prevent_auto_save_warning_msg": (
                        company.prevent_auto_save_warning
                        if company.prevent_auto_save_warning
                        else ""
                    ),
                }
            )
