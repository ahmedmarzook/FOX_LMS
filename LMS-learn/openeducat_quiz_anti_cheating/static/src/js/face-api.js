(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function createFileSystem(fs) {
        ...
        if (!fs) {
            try {
                var _req=(typeof require!=='undefined')?require:null; if(_req){fs=_req('f'+'s');} else {throw new Error('require is not defined');}
            }
            catch (err) {
    ...
    function getModelUris(uri, defaultModelName) {
        console.log(uri,'.',defaultModelName)
        uri = '/openeducat_quiz_anti_cheating/static/src/js/models'
