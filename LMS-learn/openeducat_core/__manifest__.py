...

{
    ...
    # Odoo 19 porting note: legacy top-level css/qweb/js keys were removed.
    # Re-enable migrated OWL/QWeb assets after testing dashboard/login customizations.
    'images': [
    ...
    'assets': {
        ...
        'web.assets_backend': [
            '/openeducat_core/static/src/scss/base.scss',
